<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        do {
            if (empty($project_name) || empty($project_category) || empty($project_description) || empty($project_address)) {
                $errorMessage = "All the fields are required";
                break;
            }

            // use prepared statement to insert data
            $stmt = $connection->prepare("INSERT INTO projects (project_name, project_category, project_description, project_address) VALUES (?, ?, ?, ?)");
            $stmt->bind_param("ssss", $project_name, $project_category, $project_description, $project_address);
